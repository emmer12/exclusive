            ...
            <div class="untitled__slides">
                <div class="untitled__slide">
                    ...
                    <div class="untitled__slideContent">
                        <span></span> 
                        <span>Tunner</span>
                        <a class="button" href="/register" target="/black">Get Started</a>
                    </div>
                </div>
                <div class="untitled__slide">
                    <div class="untitled__slideBg"></div>
                ...
                <div class="untitled__slide">
                    ...
                    <div class="untitled__slideContent">
                        <span>Guide my</span> 
                        <span>Vocal path</span>
                        <a class="button" href="https://unsplash.com/@mariocalvo" target="/black">Get Started</a>
                    </div>
                </div>
            </div>
...
$slides: 4;
$images: url("/images/slider/slide1.jpg") url("/images/slider/slide2.jpg") url("/images/slider/slide3.jpg")  url("/images/slider/slide4.jpg");
